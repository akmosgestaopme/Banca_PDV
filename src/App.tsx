...
const AppContent: React.FC = () => {
  ...
  const renderCurrentPage = () => {
    switch (currentPage) {
      ...
      case 'produtos': return <ProductsScreen />;
      case 'caixa': return <CashScreen />;
      case 'categorias': return <CategoriesScreen />;
      case 'aparencia': return <AppearanceScreen />;
      case 'fornecedores': return <SuppliersScreen />;
      case 'financeiro': return <FinancialScreen />;
      case 'dados-empresa': return <CompanyDataScreen />;
      case 'usuarios': return <UsersScreen />;
      case 'cargos-permissoes': return <RolesPermissionsScreen />;
      case 'notificacoes': return <NotificationsScreen />;
